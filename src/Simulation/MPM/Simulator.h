...
class MPMSimulator
{
  ...
  public:
    auto& refModel(int idx = 0) { return h_models[idx]; }
    auto& refGeometryPtr(int idx = 0) { return refModel(idx).refGeometryPtr(); }
    ...
    auto& refTransformerPtr() { return _pTrans; }
    auto& refGridPtr() { return _pGrid; }
    auto& refTimeIntegratorPtr() { return _pTimeIntegrator; }

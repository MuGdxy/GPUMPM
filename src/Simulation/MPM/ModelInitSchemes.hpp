...
auto Initialize_Data<T, 7>()
{
    ...
    std::string fileName = MPM_PROJECT_SOURCE_DIR "/Assets/two_dragons.sdf";
    ...
    pd.LoadSDF(fileName, levelsetDx, levesetMinx, levelsetMiny, levelsetMinz, levelsetNi, levelsetNj, levelsetNk);
